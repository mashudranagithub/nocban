...
<section class="section-title img-about">
    ...
    <div class="container">
        <h1>Children of Asia International Sports Games</h1>
    </div>
</section>
<!-- End Section Title --> 
    ...
    <div class="crumbs">
        <div class="container">
            <ul>
                ...
                <li>/</li>
                <li>Children of Asia International Sports Games</li>
    ...
    <div class="container padding-top">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="panel-box">
                    <div class="titles">
                        <h4><i class="fa fa-rocket"></i>Children of Asia International Sports Games</h4>
                    </div>
                    <!-- Info ABout --> 
                    <div class="row">
                        <div class="col-md-12">
