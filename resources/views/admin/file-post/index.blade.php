...
<div class="row mb-4">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            <a class="btn btn-success" href="{{ route('create-file-post') }}"> Create New post</a>
        </div>
    </div>
</div>
        ...
        <table id="post-datatable" class="table table-striped dataTable">
            ...
            <tbody>
                ...
                <tr class="odd">
                    ...
                    <td>
                        <form action="{{ route('delete-file-post',$post->id) }}" method="POST">
                            <a class="btn btn-info" href="{{ route('show-file-post',$post->id) }}">Show</a>
                            <a class="btn btn-primary" href="{{ route('edit-file-post',$post->id) }}">Edit</a> {!! Form::open(['method' => 'DELETE','route' => ['delete-file-post', $post->id],'style'=>'display:inline']) !!} {!! Form::submit('Delete', ['class'
