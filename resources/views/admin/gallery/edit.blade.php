            ...
            <form action="{{ route('updateGallery', $gallery->id) }}" method="POST"
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="" class="">Gallery Existing Thumbnail Image</label>
                                <img width="100%" src="{{ asset('frontend/assets/img/galleries_thumbnails/'.$gallery->image) }}" alt="Thumbnail image">
                                <br>
                            </div>
                        </div>
