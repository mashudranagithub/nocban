            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="category" class="form-control" id="category" required>
                        ...
                        <option value="activities_proposed">Activities - (Proposed)</option>
                        ...
                        <option value="results_local">Results (Local)</option>
                        <option value="results_national">Results (National)</option>
                        <option value="results_international">Results (International)</option>
                        <option value="achievement_national">Achievement (National)</option>
                        <option value="achievement_international">Achievement (International)</option>
                    </select>
                </div>
            </div>
            <div class="col-md-8">
